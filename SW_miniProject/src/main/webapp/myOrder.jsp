...
String query = "select p.p_fileName, p.p_name, o.totalPrice, TO_CHAR(o.orderDate, 'YYYY.MM.DD') as orderDate, s.`status` from product p, `order` o, ordereditem i, shipping s "
		...
		<li class="goods_pay_item payorder">
			...
			<div class="seller_item">
				<div class="inner">
					...
					<a href=/index.jsp" class="state_button qna" target="_blank">문의하기</a>
				</div>
			</div>
		</li>
		<%
